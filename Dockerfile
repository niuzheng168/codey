...
COPY --chown=node:node skills/config-new-codey-machine/scripts/codey_node/common/__init__.py skills/config-new-codey-machine/scripts/codey_node/common/archives.py skills/config-new-codey-machine/scripts/codey_node/common/codex_cli.py skills/config-new-codey-machine/scripts/codey_node/common/config_defaults.py skills/config-new-codey-machine/scripts/codey_node/common/config_files.py skills/config-new-codey-machine/scripts/codey_node/common/toml_edit.py skills/config-new-codey-machine/scripts/codey_node/common/errors.py skills/config-new-codey-machine/scripts/codey_node/common/files.py skills/config-new-codey-machine/scripts/codey_node/common/model_test.py skills/config-new-codey-machine/scripts/codey_node/common/registration.py skills/config-new-codey-machine/scripts/codey_node/common/verification.py ./skills/config-new-codey-machine/scripts/codey_node/common/
...
COPY --chown=node:node skills/config-new-codey-machine/scripts/codey_node/platforms/linux/__init__.py skills/config-new-codey-machine/scripts/codey_node/platforms/linux/build.py skills/config-new-codey-machine/scripts/codey_node/platforms/linux/cli.py skills/config-new-codey-machine/scripts/codey_node/platforms/linux/codex_latest.py skills/config-new-codey-machine/scripts/codey_node/platforms/linux/codex_process.py skills/config-new-codey-machine/scripts/codey_node/platforms/linux/copilot_api.py skills/config-new-codey-machine/scripts/codey_node/platforms/linux/install.py skills/config-new-codey-machine/scripts/codey_node/platforms/linux/login.py skills/config-new-codey-machine/scripts/codey_node/platforms/linux/replacement.py skills/config-new-codey-machine/scripts/codey_node/platforms/linux/supervisor.py skills/config-new-codey-machine/scripts/codey_node/platforms/linux/systemd.py skills/config-new-codey-machine/scripts/codey_node/platforms/linux/updater_service.py ./skills/config-new-codey-machine/scripts/codey_node/platforms/linux/
