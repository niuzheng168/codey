...
COPY --chown=node:node skills/config-new-codey-machine/scripts/codey_node/platforms/linux/__init__.py skills/config-new-codey-machine/scripts/codey_node/platforms/linux/build.py skills/config-new-codey-machine/scripts/codey_node/platforms/linux/cli.py skills/config-new-codey-machine/scripts/codey_node/platforms/linux/install.py skills/config-new-codey-machine/scripts/codey_node/platforms/linux/legacy_takeover.py skills/config-new-codey-machine/scripts/codey_node/platforms/linux/supervisor.py skills/config-new-codey-machine/scripts/codey_node/platforms/linux/systemd.py ./skills/config-new-codey-machine/scripts/codey_node/platforms/linux/
